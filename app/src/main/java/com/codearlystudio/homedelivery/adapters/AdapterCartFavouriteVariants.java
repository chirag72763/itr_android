...
public class AdapterCartFavouriteVariants extends RecyclerView.Adapter<AdapterCartFavouriteVariants.ViewHolder> {
    ...
    public AdapterCartFavouriteVariants(List<PojoVariants> listItems, Context ctx, String productId) {
    ...
    @Override
    public AdapterCartFavouriteVariants.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AdapterCartFavouriteVariants.ViewHolder(v);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final AdapterCartFavouriteVariants.ViewHolder holder, final int position) {
