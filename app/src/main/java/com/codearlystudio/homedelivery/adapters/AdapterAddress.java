...
public class AdapterAddress extends RecyclerView.Adapter<AdapterAddress.ViewHolder> {
    ...
    public AdapterAddress(List<PojoAddress> listItems, Context ctx) {
    ...
    public AdapterAddress.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AdapterAddress.ViewHolder(v);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(final AdapterAddress.ViewHolder holder, final int position) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            addressLine3 = itemView.findViewById(R.id.address_line3);
